<?php
    ...
    $machine_id = explode(", ",$machine_id);
    foreach ($machine_id as $x){
        //GET INCOME
        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "ss", $x, $username);
        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "ssss", $x, $username, $date, $row['income']);
            mysqli_stmt_execute($stmt);
        }
