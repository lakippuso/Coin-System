...
<ul id="side-menu">
    <li class="nav-item">
        <a class="link nav-link" href="admin-dashboard.php">Dashboard</a>
    <li class="nav-item">
  ...
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#">
        <div class="profile-collapse">
            <a href="profile.php" id="profile-link">
                <?php 
                    if(isset($_SESSION['session_id']) /*&& $_SESSION['session_category'] === 'admin'*/){
                        include 'config.php';
                        $username = $_SESSION['session_username'];
                        $sql = "SELECT * FROM users WHERE username = '$username'";
                        $result = mysqli_query($con, $sql);
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="collapse-nav navbar-nav">
        <a class="link-cp link nav-link" href="admin-dashboard.php" style="color: white">Dashboard</a>
