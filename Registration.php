...
<html>
    ...
    <div class="registration-body container-fluid">
        <div class="registration-row mx-center row">
            <form method="POST" action="#" class="login-card col-sm-12 col-md-12 col-lg-4 offset-lg-1" id="form">
                <div class="row">
                    <h1>Sign Up!</h1>
                </div>
                <div class="row">
                ...
                <div class="row ">
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <span class="error col" id="firstname_error">This Field is required!</span>
                    </div>
                    <div class="col-sm-6 col-lg-6">
                        <input type="text" name="lastname" id="lastname" placeholder="Lastname">
                        <span class="error col" id="lastname_error">This Field is required!</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                    ...
                    <span class="error" id="email_error" >This Field is required!</span>
                </div>
                <div class="row">
                    <div class="col">
                        <input type="text" name="username" id="username" placeholder="Username">
                    </div>
                    <span class="error" id="username_error" >This Field is required!</span>
                </div>
                <div class="row">
                    <div class="col">
                        <input type="password" name="password" id="password" placeholder="Password">
                    </div>
                    <span class="error" id="password_error" >This Field is required!</span>
                </div>
                <div class="row justify-content-center">
                    <div class="col">
                        <input type="password" name="cpassword" id="cpassword" placeholder="Confirm Password">
                    </div>
                    <span class="error" id="cpassword_error" >This Field is required!</span>
                </div>
                <div class="row">
