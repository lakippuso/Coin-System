    ...
    <body>
        <div class="login-body g-0 container-fluid">
            ...
            <div class="login-row col-sm-10 col-md-10 col-lg-7 d-flex justify-content-around mx-auto">
                <div class="image-col col-sm-8 col-md-6 col-lg-6">
                    <img src="resources/images/index.png" width="500"></img>
                </div>
                
                <form class="form-col col-sm-4 col-md-6 col-lg-4  mx-auto" method="POST" action="includes/login-include.php">
